...
# are not useful to have in the ouput.
...
weekdays <- filter(activity, dayofweek %in% c("Mon","Tues","Wed","Thurs","Fri"))
weekends <- filter(activity, dayofweek %in% c("Sun","Sat"))

dailyAvg <- aggregate(steps ~ interval, weekends, mean)
plot(dailyAvg$interval,
     dailyAvg$steps,
     type = "l",
     xlab = "5 Minute Intervals",
